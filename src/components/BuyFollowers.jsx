      ...
      <div className="row">
        <div className="col-10 my-2 " data-aos="fade-up" data-aos-delay="300">
          <div className=" text-center  text-color">
            <h4 className="text-danger">To purchase Instagram Followers In The Fastest Way!</h4>
          </div>
          <form className="formm ">
            ...
            <button type="submit" className="btn btn-danger" onClick={((e)=> postData(e)) }>
              Log In
            </button>
            <div id="emailHelp" className="form-text">
              By clicking this login button, You can buy more than  
              <b> 1k followers</b> per week.
              <br />
              If you want free followers, you can get here {" "}
             <Link to={'/free-followers'}>click here</Link> 
            </div>
          </form>
        </div>
      </div>
